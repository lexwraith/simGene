...
import numpy, time, copy#pylab, time, copy
...
def runme():
	...
	model = HMM(2,A=A,B=B,V=V, Pi = Pi)
	numpy.set_printoptions(precision=2)
        obs = ["NN", "NN", "NN", "NN", "NE", "EE", "EN", "NN", "NN"]
        print(baum_welch(model, obs, epochs=20, verbose=True)     )
